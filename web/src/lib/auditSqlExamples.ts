import type { AuditSqlExample } from '@/types/api';

export const AUDIT_SQL_EXAMPLES: AuditSqlExample[] = [
  {
    diff: 'Easy',
    title: 'List user tables',
    text: 'Show every application table in the public schema.',
...
export function filterAuditExamplesForSchema(tableNames: Set<string>): AuditSqlExample[] {
