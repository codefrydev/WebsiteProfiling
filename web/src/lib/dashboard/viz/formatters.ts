 ...
 *   "0.0"    — fixed 1 decimal      "0.00" — fixed 2 decimals (any number of 0s)
 *   "0.0%"   — value is a FRACTION (0–1); scaled ×100 and suffixed with %
 *   "%"      — legacy fraction percent, 1 decimal
 *   "pct"    — value is ALREADY a percentage (0–100); suffixed with % as-is
