...
export const PIPELINE_CONFIG_SECTIONS: PipelineConfigSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'enable_google_keyword_planner',
        label: 'Google Ads Keyword Planner',
        type: 'bool',
        span: 1 as const,
        defaultValue: false,
        help: 'Use Google Ads Keyword Planner to fetch official search volume and competition. Requires developer token and login customer ID in Integrations.',
      },
      {
        key: 'enable_keyword_forecast',
        label: 'Keyword Planner forecasts',
        type: 'bool',
        span: 1 as const,
        defaultValue: false,
        help: 'Attach click/conversion forecasts to top keywords. Requires Keyword Planner enabled above.',
      },
      {
        key: 'google_ads_language_id',
        label: 'Ads language ID',
        type: 'number',
        span: 1 as const,
        defaultValue: '1000',
        placeholder: '1000',
        help: 'Google Ads language constant ID (1000 = English). See Google Ads language codes.',
      },
      {
        key: 'google_ads_geo_ids',
        label: 'Ads geo target IDs',
        type: 'text',
        span: 1 as const,
        defaultValue: '2840',
        placeholder: '2840',
        help: 'Comma-separated Google Ads geo target constant IDs (2840 = United States). See Google Ads geotargeting.',
      },
    ],
  },
  {
