...
/**
 * @param {object} props
 * @param {Array<object>} props.rows - flattened tree rows with pathKey, depth, segment, children, current, baseline
 * @param {Set<string>} props.expanded
 * @param {(pathKey: string) => void} props.onToggle
 * @param {boolean} props.hasCompare
 * @param {boolean} props.showCompareCharts
 * @param {object} props.s - strings.views.siteStructure
 */
export default function PathTreeTable({ rows, expanded, onToggle, hasCompare, showCompareCharts, s }) {
...
function formatCompareTitle(template, b, c) {
