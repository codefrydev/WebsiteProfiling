...
export function buildQueryExportColumns(sp: { table: Record<string, string> }): ExportColumn[] {
  return [
...
export function buildPageExportColumns(sp: { table: Record<string, string> }): ExportColumn[] {
  return [
