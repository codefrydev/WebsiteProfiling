...
- **MCP:** `python -m website_profiling.mcp` (stdio, **240 read-only audit tools**, domain-scoped via `WP_MCP_DOMAIN`). See `docs/MCP.md`. Requires `pip install -r requirements.txt`.
