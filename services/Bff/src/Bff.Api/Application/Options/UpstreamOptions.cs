namespace Bff.Api.Application.Options;
...
public sealed class UpstreamOptions
{
    ...
    /// <summary>Data service base URL (env override: DATA_SERVICE_URL or CORE_SERVICE_URL). Core .NET service.</summary>
    public string DataBaseUrl { get; set; } = "http://127.0.0.1:8094";

    /// <summary>Integrations service base URL (env override: INTEGRATIONS_SERVICE_URL or CORE_SERVICE_URL).</summary>
    public string IntegrationsBaseUrl { get; set; } = "http://127.0.0.1:8094";
