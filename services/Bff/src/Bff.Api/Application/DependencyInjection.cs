    ...
    public static IServiceCollection AddBffApplication(this IServiceCollection services)
    {
        services.AddOptions<UpstreamOptions>()
            ...
            .PostConfigure(o =>
            {
                ...
                {
                    o.DataBaseUrl = core.Trim();
                    o.IntegrationsBaseUrl = core.Trim();
                    o.ReportBaseUrl = core.Trim();
                }
        ...
        services.AddHttpClient<Bff.Application.Generated.IFastApiClient, Bff.Application.Generated.FastApiClient>()
            .ConfigureHttpClient((sp, client) =>
            {
                var opts = GetUpstream(sp);
                client.BaseAddress = NormalizeBase(opts.FastApiBaseUrl);
