...
public class DashboardsIntegrationTests : IClassFixture<WebApplicationFactory<Api.Program>>, IAsyncLifetime
{
    ...
    public DashboardsIntegrationTests(WebApplicationFactory<Api.Program> factory)
    {
