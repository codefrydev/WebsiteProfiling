...
public class PropertiesIntegrationTests : IClassFixture<WebApplicationFactory<Api.Program>>, IAsyncLifetime
{
    ...
    public PropertiesIntegrationTests(WebApplicationFactory<Api.Program> factory)
    {
